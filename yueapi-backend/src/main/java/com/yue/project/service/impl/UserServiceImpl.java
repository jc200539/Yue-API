...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public boolean isAdmin(HttpServletRequest request) {
        // 仅管理员可查询
        String cookie = CookieUtil.getCookieValue(request,"yue_login_token");
    ...
    public UserDevKeyVO genKey(HttpServletRequest request) {
        ...
        UserDevKeyVO userDevKeyVO = this.genKey(userId.toString());
        ...
        String newJson = JSONUtil.toJsonStr(user);
        redisUtil.set("session:" + cookie, newJson, 1800);
