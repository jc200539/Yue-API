...
import com.yue.project.model.dto.interfaceInfo.InterfaceInfoAddRequest;
import com.yue.project.model.dto.interfaceInfo.InterfaceInfoInvokeRequest;
import com.yue.project.model.dto.interfaceInfo.InterfaceInfoQueryRequest;
import com.yue.project.model.dto.interfaceInfo.InterfaceInfoUpdateRequest;
import com.yue.apicommon.model.entity.InterfaceInfo;
import com.yue.apicommon.model.entity.User;
import com.yue.project.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    private final static String COOKIE_NAME = "yue_login_token";
    ...
    public BaseResponse<Boolean> deleteInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        Long userId = getUserIdByCookie(request);
        // 判断是否存在
        InterfaceInfo oldInterfaceInfo = interfaceInfoService.getById(deleteRequest.getId());
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        userInterfaceInfoQueryWrapper.eq("interface_info_id", id);
        ...
        int leftNum = userInterfaceInfo.getLeft_num();
        if (leftNum <= 0) {
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "调用次数不足！");
        }
        // 3.发起接口调用
